...
<body>
        ...
        <div class="bg-gradiant">
            <div id="login-container" class="d-flex justify-content-center align-items-center">
                <div class="bg-dark text-white p-3 rounded w-25">
                    ...
                    <h3 id="loginHeading" class="text-center">Signup</h3>
                    ...
                    <form id="signupForm" method="post">
                        <div class="mb-3">
                            ...
                            <div id="userRoleErr" class="form-text text-danger"></div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="confirmPasswordErr" class="form-text text-danger"></div>
                        </div>
                        <div class="mt-3 text-center">
                            <button type="submit" name="signupBtn" id="signupBtn" class="btn btn-outline-primary w-25">Signup</button>
                        </div>
    ...
    <script src="../../lib/js/signup_admin.js"></script>
</body>
